...
<template>
 <div :class="{'sticky-top': isSticky}">
    <div class=" nav-bar bg-transparent" :class="{'sticky-top': isSticky}" :style="{ marginTop: isSticky ? '45px' : '0' }">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="index.html" class="navbar-brand d-flex align-items-center text-center">
                    <div class="icon p-2 me-2">
                        <img class="img-fluid" src="/src/assets/img/logo1.PNG" alt="Icon" style="width: 45px; height: auto;">
                    </div>
                    <h1 class="m-0 text-primary">Альянс Експерт</h1>
                </a>
